...
if __name__ == "__main__":    
    # print(get_urlData('https://jobs.lever.co/pillpack/5ed959c8-5777-4298-ab6a-8e64be331c7a'))
    # # pass   
    html = open("Lynx.htm").read() # string.
    html = ModifyHTML(html, "html5lib") #BeautifulSoup object.
    html.shift_links()
    html.remove_images()
    html = html.raw() # string version of the HTML with shifted links and no images.
    # print(html)
    ...
    print(plain)
    # print(HTMLToText().text("Lynx.htm")) # returns plain text version of "sample.html"

    # lynx -nolist -nomargins -cfg <(echo COLLAPSE_BR_TAGS:FALSE) -dump Lynx.htm
