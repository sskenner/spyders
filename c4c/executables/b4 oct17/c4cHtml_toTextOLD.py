...
if __name__ == "__main__":    
    # pass
    print(HTMLToText().text("exStanfordHTML.html")) # returns plain text version of "sample.html"
    
    # html = open("Sample index.html file.html").read() # string.
    # html = ModifyHTML(html, "html5lib") #BeautifulSoup object.
    # html.shift_links()
    # html.remove_images()
    # print(html.raw()) # string version of the HTML with shifted links and no images.
